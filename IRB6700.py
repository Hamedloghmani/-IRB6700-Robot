...
class IRB6700:
    ...
    """
    def __init__(self, axis_limitations=((-170, 170), (-180, 70), (-180, 70), (-300, 300), (-130, 130), (-360, 360)),
    ...
    def forward_kinematics(self, thetas: list) -> list:
        """
            ...
            """
        dh_for_link0 = self.create_dh_matrix(theta=thetas[0], alpha=-90, r=0, d=780)
        dh_for_link1 = self.create_dh_matrix(theta=thetas[1], alpha=0, r=0, d=0)
        dh_for_link2 = self.create_dh_matrix(theta=thetas[2], alpha=-90, r=200, d=0)
        dh_for_link3 = self.create_dh_matrix(theta=thetas[3], alpha=90, r=0, d=1182.5)
